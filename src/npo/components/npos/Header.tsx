      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl px-4 py-2 pr-10 text-sm font-medium text-gray-700 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all cursor-pointer hover:bg-gray-50 min-w-[140px]"
                >
            ...
            <motion.button
              ...
              className="flex items-center gap-2 px-4 py-2 text-teal-600 hover:bg-teal-50 rounded-xl transition-all border border-teal-200/50"
            >
              <motion.div
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          ...
          <motion.button
            ...
            disabled={loading}
            className="px-6 py-3 bg-teal-500 hover:bg-teal-600 text-white rounded-2xl font-medium shadow-lg transition-all disabled:opacity-50 min-w-[100px] flex items-center justify-center"
          >
            {loading ? (
        ...
        <AnimatePresence>
          {showFilters && (
            ...
            >
              ...
              {/* Acciones de filtros */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-4 border-t border-gray-200/50">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500">
                  ...
                  <span className="text-center sm:text-left">
                    Las fechas requieren especificar el tipo (antes/después)
                  </span>
                </div>
              </div>
            </motion.div>
